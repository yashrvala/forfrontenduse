...
if st.button("Get Estimate"):
    ...
    # Read backend URL from environment variable (fallback to your Render backend)
    backend_url = os.getenv("BACKEND_URL", "https://appcost-backendd.onrender.com/estimate")

    # Call backend API with retries
    for i in range(10):
        try:
